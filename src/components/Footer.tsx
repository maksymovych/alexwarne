  ...
  return (
    <footer className="py-6 border-t border-black/6">
      <div className="max-w-[1120px] mx-auto px-6 flex flex-wrap items-center justify-between gap-4 text-[0.8rem] text-ink-light">
        <span className="font-display text-base text-teal">Alex Warne &amp; Associates</span>
        <span>Health Care Recruiter &nbsp;·&nbsp; Burlington, Ontario &nbsp;·&nbsp; Consultant to Executive Solutions Ltd.</span>
